...
#define MSCB_LIBRARY_VERSION   "2.2.2"
...
\********************************************************************/
{
   ...
   /* read result */
   n = mscb_in(fd, buf, sizeof(buf), 10);
   mscb_release(fd);
