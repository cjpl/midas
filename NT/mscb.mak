...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\mscb.pdb" /machine:I386 /out:"$(OUTDIR)\mscb.dll" /implib:"$(OUTDIR)\mscb.lib" 
LINK32_OBJS= \
	"$(INTDIR)\mscb.obj" \
	"$(INTDIR)\rpc.obj"

"$(OUTDIR)\mscb.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
