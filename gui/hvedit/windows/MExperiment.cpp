...
BOOL CMExperiment::Connect(CString strHostName, CString strExperimentName, CString strClientName)
{
   ...
   do {
      status = cm_connect_experiment1((char *) (LPCTSTR) m_strHostName, (char *) (LPCTSTR) m_strExperimentName, (char *) (LPCTSTR) m_strClientName, GetPassword, DEFAULT_ODB_SIZE, 20000);      /* increased timeout for W95 */
