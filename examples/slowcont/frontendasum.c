...
#include <stdio.h>
#include "midas.h"
#include "class/cd_asum.h"
#include "device/dd_mscbasum.h"
#include "mscbbus.h"

/*-- Globals -------------------------------------------------------*/

/* The frontend name (client name) as seen by other MIDAS clients   */
char *frontend_name = "T2K-ASUM";
...
/* device driver list */
DEVICE_DRIVER asum_driver[] = {
   {"T2K-ASUM", mscbasum, 1, NULL},
   {""}
};
...
EQUIPMENT equipment[] = {
 {"ASUM",                     /* equipment name */
    {3, 0,                      /* event ID, trigger mask */
     ...
     "", "", ""} ,
    cd_asum_read,                 /* readout routine */
    cd_asum,                      /* class driver main routine */
    asum_driver,                  /* device driver list */
    NULL,                       /* init string */
    },
   {""}
};
