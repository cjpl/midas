/********************************************************************\
  ...
  Contents:     Frontend code for mevb example.
                Duplicate source code from the fe1.c for
		mevb example purpose.
...
INT read_trigger_event(char *pevent, INT off)
{
   ...
   /* create TDC bank */
   bk_create(pevent, "TDC2", TID_WORD, &pdata);
...
INT read_scaler_event(char *pevent, INT off)
{
   ...
   /* create SCLR bank */
   bk_create(pevent, "SCL2", TID_DWORD, &pdata);
